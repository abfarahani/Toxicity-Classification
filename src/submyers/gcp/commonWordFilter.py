...
with open("testWordCounts.csv",mode='r') as input:
...
fileContent = ""
with open("trainWordStats.csv",mode='r') as input:
	fileContent = input.read()
...
with open("testWordCountsFilter.csv",mode="w") as testOutput:
	with open("trainWordStatsFilter.csv",mode="w") as trainOutput:
		testOut = ""
		trainOut = ""
