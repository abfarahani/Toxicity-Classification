...
"""
This function reads in a file generated by extractAllTestWordsSingQuite.py and 
one from calcWordStatsSingQuote.py and filters out all non-common words to 
generate two new filtered copies of the files.
"""
